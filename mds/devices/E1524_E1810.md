...
It may help to remove the battery for a few seconds and after that reconfigure it via [Configure](../zigbee2mqtt.io/docs/guide/usage/mqtt_topics_and_messages.md#zigbee2mqttbridgeconfigure). Right before executing the Configure make sure to wake up the device by pressing a button on it.
...
### Binding
The [binding](../zigbee2mqtt.io/docs/guide/usage/binding.md) functionallity of this remote varies per firmware version:
...
2. Add/store [scenes](../zigbee2mqtt.io/docs/guide/usage/scenes.md) for the created group
