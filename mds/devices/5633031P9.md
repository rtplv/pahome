...
See [Touchlink](../zigbee2mqtt.io/docs/guide/usage/touchlink.md)
...
Send a MQTT command to [`zigbee2mqtt/FRIENDLY_NAME/set`](../zigbee2mqtt.io/docs/guide/usage/mqtt_topics_and_messages.md#zigbee2mqtt-friendly-name-set) with the following payload.
